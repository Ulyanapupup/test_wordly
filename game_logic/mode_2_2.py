...
class WordlyGame:
    ...
    def add_player(self, player_id):
        """Добавляет игрока, возвращает True если добавлен"""
